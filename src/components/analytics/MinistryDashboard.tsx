    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="bg-slate-50 rounded-3xl p-6 sm:p-8 border border-slate-200 space-y-4">
        ...
        <p className="text-xs text-slate-600">
          Statutory verification verifying that beneficiary caste categories, annual incomes, and personal identifiers comply with <strong>Sections 4, 6 & 8 of India's Digital Personal Data Protection (DPDP) Act, 2023</strong>.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
          <div className="p-3 bg-white rounded-xl border border-slate-200">
            <span className="text-slate-400 block text-[10px] uppercase font-bold">Purpose Limitation</span>
            <strong className="text-emerald-700">100% Compliant (Enforced)</strong>
            <p className="text-[11px] text-slate-500 mt-0.5">Used strictly for scheme matching.</p>
          </div>

          <div className="p-3 bg-white rounded-xl border border-slate-200">
            <span className="text-slate-400 block text-[10px] uppercase font-bold">Data Retention</span>
            <strong className="text-emerald-700">Zero Persistent Storage</strong>
            <p className="text-[11px] text-slate-500 mt-0.5">In-memory session, auto-purged on exit.</p>
          </div>

          <div className="p-3 bg-white rounded-xl border border-slate-200">
            <span className="text-slate-400 block text-[10px] uppercase font-bold">Consent Audit Record</span>
            <strong className="text-slate-900">Cryptographically Tokenized</strong>
            <p className="text-[11px] text-slate-500 mt-0.5">Explicit consent captured prior to run.</p>
          </div>
        </div>
      </div>
